...
namespace FixedServiceAllowanceAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<FixedServiceAllowanceContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("FixedServiceAllowanceContext")));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env,FixedServiceAllowanceContext db)
        {
            db.Database.Migrate();
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "FixedServiceAllowanceAPI v1"));
            }
