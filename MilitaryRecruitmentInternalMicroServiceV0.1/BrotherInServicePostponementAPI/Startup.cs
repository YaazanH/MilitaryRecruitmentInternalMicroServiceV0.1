...
namespace BrotherInServicePostponementAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<BrotherInServicePostponementContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("BrotherInServicePostponementContext")));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env,BrotherInServicePostponementContext db)
        {
            db.Database.Migrate();
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "BrotherInServicePostponementAPI v1"));
            }
